...
# File move detection has been removed to simplify behavior and avoid side-effects.
...
# Server-side move endpoint is no longer used.
...
def do_sync(auto_upload=False, auto_delete=False):
    ...
    try:
        ...
        # 3. Skip move detection; we only handle new/modified/orphan files now
